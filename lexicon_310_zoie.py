...
lex["RETURNS"] = Packet([Request(text="verb RETURNS", test_flag=True,
                                 assigns={"CD": "RETURNS", "PART-OF-SPEECH": "verb"}, calls=[["PTRANS", None, None]],
                                 # todo: new added "CHECK CONTAIN"
                                 # calls=[["INGESTED", None, None],["CHECK CONTAIN"]],
                                 # todo 1: have ingest call (like ptarns for above) and waiting for preposition, and in the prp TO have update act.
                                 # todo 2: 2 patterns for sentences.

                                 next=Packet([Request(text="CD is TO from lex RETURNS",
                                                      tests={"CD": "TO", "PART-OF-SPEECH": "preposition"},
                                                      calls=[["ADVANCE TIME"],["CHECK CONTAIN"]])],
                                                        # todo: add check contain here or?
                                             keep=True))])
...
analyzer.parse("Blood enters the right side of your heart. Blood travels to the lungs. Carbon-dioxide is removed from the blood. Oxygen is added to your blood. Blood returns to left side of your heart.")
# analyzer.parse("Carbon-dioxide is removed from the blood.")
# todo: okay
